...
public class MultiThreadsClientsPost {
  ...
  private static final String WRITE_OUT_PATH= "output" + File.separator + "result.csv";


  private static int TIME_ZONE_DIFF = 1;
  private static int REQUEST_DURATION = 3;

  private static final String[] HEADERS = {ORDER_ID_FLAG,CLIENT_ID_FLAG,TIME_ZONE_FLAG,STATUS_CODE_FLAG,LATENCY_FLAG};
